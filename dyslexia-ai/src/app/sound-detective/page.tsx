...
const POOL = [
  'МУУР', 'НОХОЙ', 'ЗАГАС', 'ШУВУУ', 'МОРЬ', 'АЛИМ',
  'НАР', 'МОД', 'ЦЭЦЭГ', 'НОМ', 'ГЭР', 'СУМ', 'ТОМ', 'ХОТ',
];
      ...
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        <LinearGradient colors={['#D8E6EC', '#E8E3F5']} style={styles.qCard}>
          ...
          <Pressable
            ...
            onPress={() => q && speak(q.word)}
            disabled={ttsBusy}
          >
            <AppIcon name="volume" size={20} color="#fff" />
            <Text style={styles.listenText}>{ttsBusy ? 'Сонсож байна…' : 'Дахин сонсох'}</Text>
          </Pressable>
        </LinearGradient>
